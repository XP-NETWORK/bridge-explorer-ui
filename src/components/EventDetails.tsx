      ...
      <div className="p-4 bg-white mt-5 sm:rounded-2xl rounded-lg shadow-[0_1px_15px_0px_#2F303214]">
        ...
        <div className="flex items-start sm:border sm:p-5 sm:rounded-2xl flex-col sm:flex-row gap-5 sm:">
          ...
          <div className="w-full">
            <div className="grid sm:grid-cols-8 gap-3 py-3 border-b sm:border-0">
              <div className="sm:col-span-2 font-medium text-sm">NFT:</div>
            ...
            <div className="grid sm:grid-cols-8 gap-3 py-3 border-b sm:border-0 ">
              ...
              <div className="sm:col-span-6 break-all text-sm text-[#235EF5]">
                ...
                <span className="sm:hidden">
                  {event?.fromHash?.slice(0, 6)}...{event?.fromHash?.slice(-15)}
                </span>
                <ReactTooltip
                  effect="solid"
                ...
                >
                  <img src={CopyIcon} width={15} alt="copy button" />
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="w-full sm:my-5">
          ...
          <div className="grid items-center sm:grid-cols-6 gap-3 py-4  sm:px-4  border-b">
            <div className="sm:col-span-1 font-medium text-sm">Dest Hash:</div>
            <div className="sm:col-span-5 break-all text-sm text-[#235EF5]">
              <span className="hidden sm:inline">{event?.toHash || "N/A"}</span>
              <span className="sm:hidden">
                {event?.toHash?.slice(0, 6)}...{event?.toHash?.slice(-15)}
              </span>
              <ReactTooltip
                effect="solid"
                className={`${tooltipCopy ? "copyTip copied" : "copyTip"}`}
          ...
          <div className="grid sm:grid-cols-6 gap-3 py-4 sm:px-4  border-b ">
            <div className="sm:col-span-1 font-medium5 text-sm">From:</div>
            <div className="sm:col-span-5 break-all text-sm text-[#235EF5]">
              <span className="hidden sm:inline">
          ...
          <div className="grid sm:grid-cols-6 gap-3 py-4 sm:px-4  border-b ">
            <div className="sm:col-span-1 font-medium5 text-sm">To:</div>
            <div className="sm:col-span-5 break-all text-sm text-[#235EF5]">
              <span className="hidden sm:inline">
          ...
          <div className="grid items-center sm:grid-cols-6 gap-3 py-4 sm:px-4  border-b">
            <div className="sm:col-span-1 font-medium5 text-sm">Date:</div>
          ...
          <div className="grid items-center sm:grid-cols-6 gap-3 py-4 sm:px-4  sm:border-b">
            <div className="sm:col-span-1 font-medium 5 text-sm">Status:</div>
            <div className="sm:col-span-5 text-sm">
